...
public class prataLang implements prataLangConstants {
  ...
  private void five () {
    switch (tipo){
      case 5:
        InstructionArea instruction = new InstructionArea<Integer>(pointer, "LDI", Integer.valueOf(token.toString()));
        instructionArea.add(instruction);
        pointer++;
        break;
      case 6:
        InstructionArea instruction1 = new InstructionArea<Float>(pointer, "LDR", Float.valueOf(token.toString()));
        instructionArea.add(instruction1);
        pointer++;
        break;
      case 7:
        InstructionArea instruction2 = new InstructionArea<String>(pointer, "LDS", token.toString());
