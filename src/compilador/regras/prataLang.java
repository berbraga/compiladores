...
public class prataLang implements prataLangConstants {
  ...
  public static void main(String[] args) throws ParseException {
    ...
    if (args[i].equals("-")){
      ...
      try{
        parser = new prataLang(new FileInputStream(filename));
  ...
  public prataLang(InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public prataLang(InputStream stream, String encoding) {
  ...
  /** Constructor. */
  public prataLang(Reader stream) {
...
/** Disable tracing. */
  ...
  private void one (CompiladorGui gui)  {
    InstructionArea instruction = new InstructionArea<Integer>("STP", 0);
    instructionArea.put(pointer, instruction);
    String columns[] = {"Number", "Code", "Parameter"};
    String Data[][] = new String[3][];
    for (Integer i = 0; i < instructionArea.size(); i++){
      InstructionArea in = (InstructionArea) instructionArea.get(i++);
      Data[0][i] = String.valueOf(i++);
      Data[1][i] = in.getInstruction();
      Data[2][i] = String.valueOf(in.getParameter());
    }
  ...
  private void four () {
    if( tipo == 1 || tipo == 5 ) {
      InstructionArea instruction = new InstructionArea<Integer>( "ALI", VP);
      instructionArea.put(pointer, instruction);
      pointer++;
    }else if( tipo == 2 || tipo == 6 ) {
      InstructionArea instruction = new InstructionArea<Integer>("ALR", VP);
      instructionArea.put(pointer, instruction);
      pointer++;
    }else if( tipo == 3 || tipo == 7 ) {
      InstructionArea instruction = new InstructionArea<Integer>( "ALS", VP);
      instructionArea.put(pointer, instruction);
      pointer++;
    }else if( tipo == 4 ) {
      InstructionArea instruction = new InstructionArea<Integer>( "ALB", VP);
      instructionArea.put(pointer, instruction);
      pointer++;
  ...
  private void five () {
    switch (tipo){
      case 5:
        InstructionArea<Integer> instruction = new InstructionArea<Integer>( "LDI", Integer.valueOf(token.image));
        instructionArea.put(pointer, instruction);
        pointer++;
        break;
      case 6:
        InstructionArea<Float> instruction1 = new InstructionArea<Float>( "LDR", Float.valueOf(token.image));
        instructionArea.put(pointer, instruction1);
        pointer++;
        break;
      case 7:
        InstructionArea<String> instruction2 = new InstructionArea<String>("LDS", token.image);
        instructionArea.put(pointer, instruction2);
        pointer++;
        break;
    }
    InstructionArea instruction3 = new InstructionArea<Integer>( "STC", VP);
    ...
    if ( context == "const" || context == "var" ) {
      ...
      if ( simbolsTable.containsKey(token.image)){
        ...
        if ( aux.getCategory() == 1  || aux.getCategory() == 2  || aux.getCategory() == 3  || aux.getCategory() == 4 ) {
          InstructionArea<Integer> instruction = new InstructionArea<Integer>("REA" , aux.getCategory());
          instructionArea.put(pointer, instruction);
          pointer++;
          InstructionArea<Integer> instruction2 = new InstructionArea<Integer>("STR" , aux.getAttribute());
          instructionArea.put(pointer, instruction2);
          pointer++;
        } else{
  ...
  private void twelve (CompiladorGui gui) {
    if(simbolsTable.containsKey(token.image)){
      Auxst aux = (Auxst) simbolsTable.get(token.image);
      if ( aux.getCategory() == 1  || aux.getCategory() == 2  || aux.getCategory() == 3  || aux.getCategory() == 4 ) {
        InstructionArea instruction2 = new InstructionArea<Integer>("STR" , aux.getAttribute());
        instructionArea.put(pointer, instruction2);
        pointer++;
      } else{
        gui.jTextArea1.append("Program or Constant Identifier");
  ...
  private void fourteen () {
    InstructionArea instruction = new InstructionArea<Integer>("WRT", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void fifteen (CompiladorGui gui) {
    if(simbolsTable.containsKey(token.image)){
      ...
      if ( aux.getCategory() == 1  || aux.getCategory() == 2  || aux.getCategory() == 3  || aux.getCategory() == 4 || aux.getCategory() == 5 || aux.getCategory() == 6 ||  aux.getCategory() == 7 ) {
        InstructionArea instruction2 = new InstructionArea<Integer>("LDV" , aux.getAttribute());
        instructionArea.put(pointer, instruction2);
        pointer++;
      } else{
        gui.jTextArea1.append("Program or Constant Identifier");
  ...
  private void sixteen () {
    InstructionArea instruction = new InstructionArea<Integer>("LDI", Integer.valueOf(token.image));
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void seventeen () {
    InstructionArea instruction = new InstructionArea<Float>("LDR", Float.valueOf(token.image));
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void eighteen () {
    InstructionArea instruction = new InstructionArea<String>("LDS", token.image);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void nineteen () {
    InstructionArea instruction = new InstructionArea<Boolean>("LDB", true);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void twenty () {
    InstructionArea instruction = new InstructionArea<Boolean>("LDB", false);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void twentyone () {
    InstructionArea instruction = new InstructionArea<>( "JMF");
    pointer++;
    instructionArea.put(pointer, instruction);
    pilha.add(pointer--);
  }
  private void twentytwo () {
    InstructionArea i = (InstructionArea) instructionArea.get(pilha.peek());
    i.setParameter(pointer);
    instructionArea.remove(pilha.peek());
    instructionArea.put(pilha.peek(), i);
    pilha.pop();
  ...
  private void twentythree () {
    ...
    instructionArea.put(pilha.peek(), i);
    pilha.pop();
    InstructionArea instruction = new InstructionArea<>( "JMP");
    pointer++;
    instructionArea.put(pointer, instruction);
    pilha.add(pointer--);
  }
  ...
  private void twentysix () {
    ...
    instructionArea.put(pilha.peek(), i);
    pilha.pop();
    InstructionArea instruction = new InstructionArea<>( "JMP", pilha.peek());
    instructionArea.put(pointer, instruction);
    pilha.pop();
    pointer++;
  }
  private void twentyseven () {
    InstructionArea instruction = new InstructionArea<Integer>("EQL", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void twentyeight () {
    InstructionArea instruction = new InstructionArea<Integer>("DIF", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void twentynine () {
    InstructionArea instruction = new InstructionArea<Integer>("SMR", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void thirty () {
    InstructionArea instruction = new InstructionArea<Integer>("BGR", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void thirtyone () {
    InstructionArea instruction = new InstructionArea<Integer>("SME", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void thirtytwo () {
    InstructionArea instruction = new InstructionArea<Integer>("BGE", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void thirtythree () {
    InstructionArea instruction = new InstructionArea<Integer>("ADD", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void thirtyfour () {
    InstructionArea instruction = new InstructionArea<Integer>("SUB", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void thirtyfive () {
    InstructionArea instruction = new InstructionArea<Integer>("OR", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void thirtysix () {
    InstructionArea instruction = new InstructionArea<Integer>("MUL", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  private void thirtyseven () {
    InstructionArea instruction = new InstructionArea<Integer>("DIV", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  ...
  private void fourty () {
    InstructionArea instruction = new InstructionArea<Integer>("AND", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
  ...
  private void fourtytwo () {
    InstructionArea instruction = new InstructionArea<Integer>("NOT", 0);
    instructionArea.put(pointer, instruction);
    pointer++;
  }
